...
function [scheduleData, nextTrialNumber] = variableDelay20_6(scheduleData, currentTrialNumber, lastResult)
...
if scheduleData.LR==0
    ...
    elseif lastResult==2       
       if scheduleData.leftRewardDelay(nextTrialNumber)>6
            scheduleData.leftRewardDelay(nextTrialNumber:end)= scheduleData.leftRewardDelay(currentTrialNumber)- 0.5;
       end 
    end
else
   if lastResult ==2
    ...
    elseif lastResult==1       
       if scheduleData.rightRewardDelay(nextTrialNumber)>6
            scheduleData.rightRewardDelay(nextTrialNumber:end)= scheduleData.rightRewardDelay(currentTrialNumber)- 0.5;
       end 
    end
end