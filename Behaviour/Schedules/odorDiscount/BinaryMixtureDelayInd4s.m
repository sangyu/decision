...
function scheduleData = BinaryMixtureDelayInd4s
scheduleData.LR=0;
...
COC2=ceil(rand(size([unitaryArray; unitaryArray]))*3);
COC1=ceil(rand(size([unitaryArray; unitaryArray]))*3);
C3=COC1-COC2;
COC1(C3==0)=[];
COC2(C3==0)=[];
...
scheduleData.odor1Flow(choiceOfCue1 == 1) = 40;
scheduleData.odor1Flow(choiceOfCue1 == 2) = 20;
scheduleData.odor1Flow(choiceOfCue1 == 3) = 0;
...
scheduleData.odor2Flow(choiceOfCue2 == 1) = 40;
scheduleData.odor2Flow(choiceOfCue2 == 2) = 20;
scheduleData.odor2Flow(choiceOfCue2 == 3) = 0;
