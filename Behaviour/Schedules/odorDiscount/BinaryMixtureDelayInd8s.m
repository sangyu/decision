...
function scheduleData = BinaryMixtureDelayInd8s
scheduleData.LR=0;
...
COC2=ceil(rand(size([unitaryArray; unitaryArray]))*5);
COC1=ceil(rand(size([unitaryArray; unitaryArray]))*5);
% C3=COC1-COC2;
% COC1(C3==0)=[];
% COC2(C3==0)=[];
...
scheduleData.odor1Flow(choiceOfCue1 == 1) = 80;
scheduleData.odor1Flow(choiceOfCue1 == 2) = 60;
scheduleData.odor1Flow(choiceOfCue1 == 3) = 40;
scheduleData.odor1Flow(choiceOfCue1 == 4) = 20;
scheduleData.odor1Flow(choiceOfCue1 == 5) = 0;
...
scheduleData.odor2Flow(choiceOfCue2 == 1) = 80;
scheduleData.odor2Flow(choiceOfCue2 == 2) = 60;
scheduleData.odor2Flow(choiceOfCue2 == 3) = 40;
scheduleData.odor2Flow(choiceOfCue2 == 4) = 20;
scheduleData.odor2Flow(choiceOfCue2 == 5) = 0;
