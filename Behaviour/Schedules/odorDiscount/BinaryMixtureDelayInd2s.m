...
function scheduleData = BinaryMixtureDelayInd2s
scheduleData.LR=0;
...
COC2=ceil(rand(3*size(unitaryArray))*2);
COC1=ceil(rand(3*size(unitaryArray))*2);
C3=COC1-COC2;
COC1(C3==0)=[];
COC2(C3==0)=[];
...
scheduleData.odor1Flow(choiceOfCue1 == 1) = 20;
scheduleData.odor1Flow(choiceOfCue1 == 2) = 0;
...
scheduleData.odor2Flow(choiceOfCue2 == 1) = 20;
scheduleData.odor2Flow(choiceOfCue2 == 2) = 0;
