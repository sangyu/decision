...
% * Arbitrary numeric arrays and strings may be included for storage in the header.
function scheduleData = shapingSamp3
...
scheduleData.minRewardDelay=2;
scheduleData.maxRewardDelay=10;
...
scheduleData.leftRewardDelay = linspace(scheduleData.minRewardDelay, scheduleData.maxRewardDelay, scheduleData.N);
...
scheduleData.rewardSounds = 0 * unitaryArray;
