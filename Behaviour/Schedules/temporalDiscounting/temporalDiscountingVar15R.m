...
% * Arbitrary numeric arrays and strings may be included for storage in the header.
function scheduleData = temporalDiscountingVar15R
...
scheduleData.LR=1;
scheduleData.bigSize=2;
scheduleData.bigDelay=2.75;
scheduleData.smallSize=1;
scheduleData.smallDelay=1;
duration=15;
scheduleData.last2Result=1;
scheduleData.densityOfShooting=.1;
scheduleData.periodOfNoShooting=[1:10, 21:25, 41:45, 50:55, 65:75];
...
scheduleData.timeToShoot='correctdecision';
