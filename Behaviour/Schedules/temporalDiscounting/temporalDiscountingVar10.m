...
% * Arbitrary numeric arrays and strings may be included for storage in the header.
function scheduleData = temporalDiscountingVar10
...
scheduleData.smallValve=1;
scheduleData.bigValve=2;
duration=14;
...
if scheduleData.LR==0
    scheduleData.leftValveDuration =scheduleData.bigValve.*.03 *scheduleData.bigRewardMatrix;
    ...
    scheduleData.rightValveDuration =scheduleData.smallValve.*.03 *scheduleData.smallRewardMatrix;
...
elseif scheduleData.LR==1
    scheduleData.rightValveDuration =scheduleData.bigValve.*.03 *  scheduleData.bigRewardMatrix;
    ...
    scheduleData.leftValveDuration =scheduleData.smallValve.*.03 *  scheduleData.smallRewardMatrix;
