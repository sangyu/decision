...
% * Arbitrary numeric arrays and strings may be included for storage in the header.
function scheduleData = samp2ladder
...
scheduleData.LR=1;
scheduleData.bigSize=3;
scheduleData.bigDelay=[1:scheduleData.N]'/20;
scheduleData.smallSize=3;
scheduleData.smallDelay=[1:scheduleData.N]'/20;
duration=20;

scheduleData.timeToShoot=0;
scheduleData.densityOfShooting=.3;
scheduleData.periodOfNoShooting=[1:40];
scheduleData.shoot=unitaryArray;
scheduleData.individualValve=0.03;
...
if scheduleData.LR==0
    scheduleData.leftValveDuration =scheduleData.individualValve *scheduleData.bigRewardMatrix;
    ...
    scheduleData.rightValveDuration =scheduleData.individualValve *scheduleData.smallRewardMatrix;
    ...
    scheduleData.rightValveDuration =scheduleData.individualValve *  scheduleData.bigRewardMatrix;
    scheduleData.rightRewardDelay= [scheduleData.bigDelay, scheduleData.rewardInterval*scheduleData.bigRewardMatrix(:, 2:end)];
    scheduleData.leftValveDuration =scheduleData.individualValve *  scheduleData.smallRewardMatrix;
    scheduleData.leftRewardDelay= [scheduleData.smallDelay, scheduleData.rewardInterval*scheduleData.smallRewardMatrix(:, 2:end)];
end    
