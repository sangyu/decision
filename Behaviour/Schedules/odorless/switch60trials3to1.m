...
%, 0*unitaryArray
leftReward=[.03 * unitaryArray, .03 * unitaryArray.*bigButton, 0.03*unitaryArray.*bigButton];
rightReward=[.03 * unitaryArray, 0.03 * unitaryArray.*smallButton, 0.03 * unitaryArray.*smallButton];
...
scheduleData.trialDuration = 10 * unitaryArray;
