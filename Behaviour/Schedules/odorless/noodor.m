...
leftReward=[.03 * unitaryArray, .03 * unitaryArray, 0*unitaryArray];
rightReward=[.03 * unitaryArray, 0 * unitaryArray, 0*unitaryArray];
...
%May be a two dimensional array, where the second dimension corresponds to multiple reward deliveries.
scheduleData.leftRewardDelay = [.5 * unitaryArray, .5 * unitaryArray, .5 * unitaryArray];
...
%May be a two dimensional array, where the second dimension corresponds to multiple reward deliveries.
scheduleData.rightRewardDelay = [.5 * unitaryArray, .5 * unitaryArray, .5 * unitaryArray];
