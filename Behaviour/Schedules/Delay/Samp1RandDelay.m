...
% * Arbitrary numeric arrays and strings may be included for storage in the header.
function scheduleData = Samp1RandDelay
...
scheduleData.rewardAvailableInterval(41:60) = 5;
...
scheduleData.cueSamplingTime(31:60) = 0.3;
...
scheduleData.totalFlow(31:60) = linspace(1, 1000, 30);%Ramp up the air, to get them comfortable with it.
...
randDelay = 0.8 * rand(size(unitaryArray)) + 0.2;
